...
export const getSchoolMembersBySchoolId = async (schoolId) => {
  try {
    const response = await fetch(
      urlCopy + `/schoolMember/getMembers?schoolId=${schoolId}`,
      {
        method: "GET",
        headers: {
...
export const fetchUserIdByEmail = async (email) => {
  try {
    const response = await fetch(
      urlCopy + `/user/id?email=${encodeURIComponent(email)}`,
      {
        method: "GET",
...
export const getSchoolIdByName = async (name) => {
  try {
    const response = await fetch(
      urlCopy + `/school/get/${encodeURIComponent(name)}`,
      {
        method: "GET",
...
export const fetchRoles = async (userId, schoolId) => {
  try {
    const response = await fetch(
      urlCopy + `/schoolMember/getRoles?userId=${userId}&schoolId=${schoolId}`,
      {
        method: "GET",
...
export const getSchoolClassIdByNameAndSchoolId = async (name, schoolId) => {
  try {
    const res = await fetch(
      urlCopy + `/schoolClass/search?name=${name}&schoolId=${schoolId}`,
      {
        method: "GET",
...
export const getSubjectIdByNameAndSchoolClassId = async (
  name,
  schoolClassId
) => {
  try {
    const res = await fetch(
      urlCopy + `/subject/search?name=${name}&schoolClassId=${schoolClassId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const getLessonsBySubjectId = async (subjectId) => {
  try {
    const response = await fetch(
      urlCopy + `/lession/get?subjectId=${subjectId}`
    );
...
export const enterSchool = async (schoolId, password, userId) => {
  try {
    const response = await fetch(
      urlCopy +
        `/password/enter?schoolId=${schoolId}&password=${password}&userId=${userId}`,
      {
        method: "POST",
...
export const getMemberClassByUserIdAndSchoolId = async (userId, schoolId) => {
  const response = await fetch(
    urlCopy + `/schoolMember/searchClass?userId=${userId}&schoolId=${schoolId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const getAllTeachersBySchoolId = async (schoolId) => {
  const response = await fetch(
    urlCopy + `/schoolMember/searchTeachers?schoolId=${schoolId}`,
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
export const updateTeacher = async (
  ...
  const response = await fetch(
    urlCopy +
      `/subject/saveProfessor?professorId=${professorId}&subjectName=${subjectName}&schoolClassId=${schoolClassId}`,
    {
      method: "GET",
      header: {
        "Content-type": "application/json",
...
export const fetchTeacherEmailBySubjectNameAndSchoolClassId = async (
  subjectName,
  schoolClassId
) => {
  const response = await fetch(
    urlCopy +
      `/subject/getProfessor?subjectName=${subjectName}&schoolClassId=${schoolClassId}`,
    {
      method: "GET",
      header: {
        "Content-type": "application/json",
...
export const getSchoolClassById = async (schoolClassId) => {
  const response = await fetch(
    urlCopy + `/schoolClass/searchById?schoolClassId=${schoolClassId}`,
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
export const getAllSubjectsByTeacherUserId = async (userId) => {
  const response = await fetch(
    urlCopy + `/subject/getByTeacherId?userId=${userId}`,
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
export const getPasswordBySchoolId = async (schoolId) => {
  const response = await fetch(
    urlCopy + `/password/getBySchoolId?schoolId=${schoolId}`,
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
export const deleteSchoolMemberByUserIdAndSchoolId = async (
  userId,
  schoolId
) => {
  const response = await fetch(
    urlCopy + `/schoolMember/delete?userId=${userId}&schoolId=${schoolId}`,
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
export const getAllBlogPostBySchoolId = async (schoolId) => {
  const response = await fetch(
    urlCopy + `/blogPost/getBySchoolId?schoolId=${schoolId}`,
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
export const getAllMembersBySchoolClass = async (schoolId, schoolClassName) => {
  const response = await fetch(
    urlCopy +
      `/schoolMember/getMembers/class?schoolId=${schoolId}&schoolClassName=${schoolClassName}`,
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
